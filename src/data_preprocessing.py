...
def read_data(path: str) -> pd.DataFrame:
    """
    Read data from a jsom file and return a pandas DataFrame
...
def replace_emojis_with_test(text:str) -> str:
    """
    Replace emojis with text
    
    Args:
    test(str): Text with emojis
...
def save_data(df: pd.DataFrame, df_comments: pd.DateFrame) -> None:
    """
